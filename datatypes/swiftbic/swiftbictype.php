...
class SwiftbicType extends eZDataType
{
	...
	{
		$this->eZDataType( 	self::DATATYPE_STRING, ezpI18n::tr( 'kernel/classes/datatypes', "SWIFT - BIC code", 'Datatype name' ),
	...
	function validateSwiftbicHTTPInput( $swiftbic, $contentObjectAttribute )
	{
		...
		{
			$contentObjectAttribute->setValidationError( ezpI18n::tr( 'kernel/classes/datatypes', 'The SWIFT - BIC code is not valid.' ) );
	...
	function validateObjectAttributeHTTPInput( $http, $base, $contentObjectAttribute )
	{
		if ( $http->hasPostVariable( $base . '_data_text_' . $contentObjectAttribute->attribute( 'id' ) ) )
		{
			...
			if ( $swiftbic == "" )
			{
				...
				{
					$contentObjectAttribute->setValidationError( ezpI18n::tr( 'kernel/classes/datatypes', 'The SWIFT - BIC code is empty.' ) );
					return eZInputValidator::STATE_INVALID;
				}
			}
			else
		...
		{
			$contentObjectAttribute->setValidationError( ezpI18n::tr( 'kernel/classes/datatypes', 'Missing SWIFT - BIC code input.' ) );
			return eZInputValidator::STATE_INVALID;
		}
