...
class SirenType extends eZDataType
{
	...
	function SirenType()
	{
		$this->eZDataType( 	self::DATATYPE_STRING, ezpI18n::tr( 'kernel/classes/datatypes', "SIREN code", 'Datatype name' ),
	...
	function validateObjectAttributeHTTPInput( $http, $base, $contentObjectAttribute )
	{
		if ( $http->hasPostVariable( $base . '_data_text_' . $contentObjectAttribute->attribute( 'id' ) ) )
		{
			...
			if ( $siren == "" )
			{
				...
				{
					$contentObjectAttribute->setValidationError( ezpI18n::tr( 'kernel/classes/datatypes', 'The SIREN code is empty.' ) );
					return eZInputValidator::STATE_INVALID;
				}
			}
			else
		...
		{
			$contentObjectAttribute->setValidationError( ezpI18n::tr( 'kernel/classes/datatypes', 'Missing SIREN code input.' ) );
			return eZInputValidator::STATE_INVALID;
		}
