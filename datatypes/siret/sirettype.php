...
/*
 SIRET datatype for eZ Publish 4.1.3 minimum
 /*!

 \class   Sirettype Sirettype.php
 \date    31 mars 2011
 \author  Ronan GUILLOUX
 */

include_once( 'kernel/common/i18n.php' );
include_once( 'extension/rgisocodes/classes/siret.php' );

class SiretType extends eZDataType
{
	const DATATYPE_STRING = 'siret';
	 ...
	 */
	function validateSiretHTTPInput( $siret, $contentObjectAttribute )
	{
	...
	function validateObjectAttributeHTTPInput( $http, $base, $contentObjectAttribute )
	{
		...
		{
			$siret = $http->postVariable( $base . '_data_text_' . $contentObjectAttribute->attribute( 'id' ) );
	...
	function validateCollectionAttributeHTTPInput( $http, $base, $contentObjectAttribute )
	{
		if ( $http->hasPostVariable( $base . "_data_text_" . $contentObjectAttribute->attribute( "id" ) ) )
		{
			...
			{
				// if entered Siret is not empty then we should validate it in any case
				return $this->validateSiretHTTPInput( $siret, $contentObjectAttribute );
			}
		}
		else
...
eZDataType::register( SiretType::DATATYPE_STRING, "SiretType" );
