...
require_once('extension/rgisocodes/classes/codepostal.php');

//class eZCodePostalTest extends ezpTestCase
class eZCodePostalTest extends PHPUnit_Framework_TestCase
{
