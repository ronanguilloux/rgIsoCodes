...
require_once('extension/rgisocodes/classes/creditcard.php');

//class eZCreditCardTest extends ezpTestCase
class eZCreditCardTest extends PHPUnit_Framework_TestCase
{
